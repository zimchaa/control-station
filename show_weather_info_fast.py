...
try:
    ...
    ax1.plot(record_date, pressure_pa, color=color, label='Pressure Pa')
    # ax1.plot(record_date, pressure_pa)
    ...
    ax2.plot(record_date, temperature_celcius, color=color, label='Temperature $\degree$C')
